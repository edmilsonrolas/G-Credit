package Views.raven.menu;

import Views.raven.menu.mode.LightDarkMode;
import Views.raven.menu.mode.ToolBarAccentColor;
...
public class Menu extends JPanel {
    ...
    private void init() {
        ...
        header.setIcon(new ImageIcon(getClass().getResource("Views/raven/icon/png/logo.png")));
